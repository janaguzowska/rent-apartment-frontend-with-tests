  ...
  return (
    <article className="near-places__card place-card">
      <div className="near-places__image-wrapper place-card__image-wrapper">
        <Link to={`/offer/${currentOffer.id}`} onClick={ () => {
          window.scrollTo(0, 0);
        }}
        >
      ...
      <div className="place-card__info">
        <div className="place-card__price-wrapper">
          ...
          <button className={`place-card__bookmark-button ${currentOffer.isFavorite ? 'place-card__bookmark-button--active' : ''} button`} type="button" onClick={handleBookmarkClick}>
...
export const NearPlaceCard = connect(mapStateToProps, mapDispatchToProps)(NearPlaceCardComponent);
