  ...
  return (
    <div className="container">
      <StyledForm action="#" className="reservation__form" method="get" aria-label="Destination reservation form">
        <StyledDestinationWrapper className="reservation__destination-wrapper">
          ...
          <Select className="reservation__city-select"
        ...
        <StyledDateWrapper className="reservation__date-range-wrapper">
        ...
        <StyledOccupancyWrapper className="reservation__occupancy">
          <OccupancyConfig />
        </StyledOccupancyWrapper>
        <StyledSearchWrapper className="reservation__search-wrapper">
          <button className="reservation__search-button" type="submit">Search</button>
        </StyledSearchWrapper>
      </StyledForm>
    </div>
  );
...
const StyledOccupancyWrapper = styled.div`
  display: flex;
  //align-items: center;
  flex-grow: 2.5;
