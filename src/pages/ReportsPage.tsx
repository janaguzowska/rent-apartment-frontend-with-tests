...
export const ReportsPage = () => {
  ...
  const [offerCountByBedrooms, setOfferCountByBedrooms] = useState<
    OfferCountByBedrooms[]
  >([]);

  const offerCountSum = useMemo(
    () => offerCount.reduce((acc, offer) => acc + offer.count, 0),
    [offerCount],
  );
  ...
  useEffect(() => {
    api
      .post<ReservationCount[]>(
        '/report/search/reservation-count',
        undefined,
        {},
      )
  ...
  useEffect(() => {
    api
      .post<OfferCount[]>('/report/search/offer-count', undefined, {})
      .then(setOfferCount)
      .catch((error) => console.error('Error:', error));
  }, [setOfferCount]);
  ...
  useEffect(() => {
    api
      .post<ReviewCount[]>('/report/search/review-count', undefined, {})
      .then(setReviewCount)
      .catch((error) => console.error('Error:', error));
  }, []);
  ...
  useEffect(() => {
    api
      .post<IncomeSum[]>('/report/search/income-sum', undefined, {})
      .then(setIncomeSum)
      .catch((error) => console.error('Error:', error));
  }, []);
  ...
  useEffect(() => {
    api
      .post<OfferCountByBedrooms[]>(
        '/report/search/offers-count-by-bedrooms',
        undefined,
        {},
      )
      ...
      <div className="charts-grid">
        ...
        <div className="chart-card">
          <Chart>
            ...
            <ChartCategoryAxis>
              <ChartCategoryAxisItem
                categories={reservationCount.map((r) => r.month)}
              />
            </ChartCategoryAxis>
            <ChartSeries>
              <ChartSeriesItem
          ...
          <Chart>
            ...
            <ChartSeries>
              <ChartSeriesItem
                ...
                labels={{
                  visible: true,
                  content: (item: PieLabelArgs) =>
                    `${Math.round((item.value / offerCountSum) * 100)}%`,
                }}
              />
            </ChartSeries>
            <ChartTooltip />
        ...
        <div className="chart-card">
          <Chart>
            ...
            <ChartCategoryAxis>
              <ChartCategoryAxisItem
                categories={userRegistrations.map((u) => u.month)}
              />
            </ChartCategoryAxis>
            <ChartSeries>
              <ChartSeriesItem
        ...
        <div className="chart-card">
          <Chart>
            ...
            <ChartCategoryAxis>
              <ChartCategoryAxisItem
                categories={reviewCount.map((r) => r.rating)}
              />
            </ChartCategoryAxis>
            <ChartSeries>
              <ChartSeriesItem
        ...
        <div className="chart-card chart-card-wide">
          <Chart>
            ...
            <ChartCategoryAxis>
              <ChartCategoryAxisItem
                categories={incomeSum.map((r) => r.month)}
              />
            </ChartCategoryAxis>
            <ChartValueAxis>
        ...
        <div className="chart-card">
          <Chart>
            ...
            <ChartCategoryAxis>
              <ChartCategoryAxisItem
                categories={occupancyRate.map((o) => o.week)}
              />
            </ChartCategoryAxis>
            <ChartValueAxis>
